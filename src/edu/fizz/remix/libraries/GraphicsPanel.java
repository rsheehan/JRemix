...
public class GraphicsPanel extends JPanel {
    ...
    private Stroke stroke = new BasicStroke(2 * IMAGE_SCALE);
    private final int width;
    private final int height;
    List<DrawShape> drawShapes = new ArrayList<DrawShape>();
    List<DrawShape> nextShapes = new ArrayList<DrawShape>();
...
//        layers.add(new GraphicsLayer(width * IMAGE_SCALE, height * IMAGE_SCALE));
    ...
    void removeShapes() {
        nextShapes = new ArrayList<DrawShape>();
    }

    void exchangeShapesAndRepaint() {
        drawShapes = nextShapes;
        nextShapes = new ArrayList<DrawShape>();
        repaint();
    }
    ...
    protected void paintComponent(java.awt.Graphics g) {
        ...
        for (DrawShape shape : drawShapes) {
            drawShape(g, shape);
        }
