...
public class RemixParser extends Parser {
	...
	public static final int
		...
		LIBRARY=35, USING=36, SELFREF=37, POSSESSIVE=38, WORD=39, STRING=40;
	public static final int
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1756507596372L) != 0)) {
				{
				setState(76);
				_errHandler.sync(this);
	...
	public final BlockOfStatementsContext blockOfStatements() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1756507563604L) != 0)) {
				{
				{
				setState(301);
				statement();
	...
	public final PrintStatementContext printStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1686177448020L) != 0)) {
				{
				setState(337);
				expression(0);
				setState(342);
	...
	public final ListContentsContext listContents() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1686177448020L) != 0)) {
					{
					{
					setState(498);
					expression(0);
